...
class E2Trainer:
    ...
    def train(self, train_dataset, epochs, batch_size, grad_accumulation_steps=1, save_step=1000):

        train_dataloader = DataLoader(train_dataset, batch_size=batch_size, collate_fn=collate_fn, shuffle=True, num_workers=self.num_workers, pin_memory=True)
